...
derle:
	...
	g++ -I ./include/ -o ./lib/GirdiHatasi.o -c ./src/GirdiHatasi.cpp
	g++ -I ./include/ -o ./lib/MesafeHatasi.o -c ./src/MesafeHatasi.cpp
	g++ -I ./include/ -o ./lib/DepoHatasi.o -c ./src/DepoHatasi.cpp
	g++ -I ./include/ -o ./bin/test.exe ./lib/GirdiHatasi.o ./lib/DepoHatasi.o ./lib/MesafeHatasi.o ./lib/HizHatasi.o ./lib/Hata.o ./lib/Yolbil.o ./lib/Arac.o ./src/test.cpp
